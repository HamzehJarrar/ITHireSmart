...
export const getRecommendedCourses = async (req, res) => {
  try {
    ...
    const prompt = `You are an expert in machine learning and educational recommendation systems. I need your expertise to analyze the user's profile and recommend the most suitable training courses and be very strict with the matchimg score.
